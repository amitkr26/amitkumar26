    ...
    <section className="py-16 sm:py-24 px-4 sm:px-6 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row gap-10 sm:gap-16">
        <div className="md:w-1/3">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-accent uppercase tracking-tighter">Research</h2>
          ...
          <div className="space-y-8 sm:space-y-12">
            <div>
              <h3 className="text-[10px] sm:text-xs uppercase tracking-widest text-slate-500 mb-4 border-b border-slate-800 pb-2">Material Stack</h3>
              <div className="bg-slate-900 p-4 border-l-4 border-accent">
                <div className="text-lg sm:text-xl font-mono text-slate-200">FeCo / CoFe</div>
                <div className="text-[9px] sm:text-[10px] text-slate-500 uppercase mt-1">Magnetron Sputtered Alloys</div>
              </div>
            </div>
        ...
        <div className="md:w-2/3 space-y-10 sm:space-y-16">
          <div className="tech-card p-4 sm:p-6">
            <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-slate-200">{researchData.title}</h3>
            <p className="text-slate-400 text-xs sm:text-sm mb-4 sm:mb-6">{researchData.abstract}</p>
            
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              {researchData.workflow.map((item, i) => (
                <div key={i} className="bg-slate-950 p-3 sm:p-4 border border-slate-800">
                  <div className="text-accent font-mono text-[10px] sm:text-xs mb-2">0{i+1}</div>
                  <div className="text-[10px] sm:text-xs font-bold uppercase mb-1 sm:mb-2 text-slate-300">{item.step}</div>
                  <div className="text-[9px] sm:text-[10px] text-slate-500 leading-tight">{item.details}</div>
                </div>
              ))}
            </div>
          </div>
